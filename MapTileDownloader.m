...
-(NSString *)getUrlFromParams:(MapTileParams)params{
    ...
    int width = TILE_WIDTH*160;
    int height = TILE_HEIGHT*160;
    self.paramString = [[NSString alloc] initWithFormat:@"%@%@,%@,%@/%dX%d.png",self.baseUrl,latStringVal,longStringVal,zoomStringVal,width,height];
